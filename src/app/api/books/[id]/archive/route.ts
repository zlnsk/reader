...
// POST /Reader/api/books/:id/archive
// Sets `archived = true` on the book. User-initiated only — there is no
// server-side auto-archive; the "you just finished this" dialog on the
// client is what drives calls into this endpoint.
